...
import numpy as np
import pandas as pd
from analysis_scripts.dt_analysis import DecisionTreeC_Analysis
from analysis_scripts.xgb_analysis import XGBC_Analysis
from analysis_scripts.mlpc_analysis import MLPC_Analysis
from analysis_scripts.svm_analysis import SVMC_Analysis
from analysis_scripts.knn_analysis import KNNC_Analysis

from analysis_scripts.ancillary import prep_housing, prep_student

def main():
    parser = ArgumentParser()
    parser.add_argument('--dataset', default='student')
    parser.add_argument('--student', default="./assets/data/cleaned_student_data.csv")
    parser.add_argument('--housing', default="./assets/data/cleaned_housing_data.csv")
